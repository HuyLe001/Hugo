...
![Redis Subnet](/static/images/2-Proposal/redis-subnet.png)

### 2. Tạo Security Group
Tạo Security Group cho phép cổng 6379 từ EC2.
![Redis SG](/static/images/2-Proposal/redis-sg.png)
...
![Redis Create 1](/static/images/2-Proposal/redis-create-1.png)

4. Cấu hình Redis info
![Redis Create 2](/static/images/2-Proposal/redis-create-2.png)

5. Cấu hình Node type, ví dụ `cache.t3.micro`.
![Redis Create 3](/static/images/2-Proposal/redis-create-3.png)

6. Chọn Subnet group.
![Redis Create 4](/static/images/2-Proposal/redis-create-4.png)

7. Chọn Security Group.
![Redis Create 5](/static/images/2-Proposal/redis-create-5.png)

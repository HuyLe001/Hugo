...
![Redis Subnet](/images/2-Proposal/redis-subnet.png)

### 2. Create Security Group
Create a Security Group allowing port 6379 from EC2.
![Redis SG](/images/2-Proposal/redis-sg.png)
...
![Redis Create 1](/images/2-Proposal/redis-create-1.png)

4. Configure Redis info.
![Redis Create 2](/images/2-Proposal/redis-create-2.png)

5. Configure Node type, e.g., `cache.t3.micro`.
![Redis Create 3](/images/2-Proposal/redis-create-3.png)

6. Select Subnet group.
![Redis Create 4](/images/2-Proposal/redis-create-4.png)

7. Select Security Group.
![Redis Create 5](/images/2-Proposal/redis-create-5.png)

...
![RDS SG](/static/images/2-Proposal/rds_sg.png)
...
![RDS Subnet Group](/static/images/2-Proposal/db_subnet_group.png)

### 3. Create Database
1. Select **Databases** -> **Create database**.
2. Select **Standard create** -> **MySQL**.
3. Select version (Engine Version).
![RDS Create 1](/static/images/2-Proposal/rds_create_1.png)

4. Select **Free tier** (if using a new account) or **Dev/Test**.
![RDS Create 2](/static/images/2-Proposal/rds_create_2.png)

5. Set **DB instance identifier**, **Master username** and **password**.
![RDS Create 3](/static/images/2-Proposal/rds_create_3.png)

6. Select **Instance class** (e.g., `db.t3.micro`).
7. Configure **Storage**.
![RDS Create 4](/static/images/2-Proposal/rds_create_4.png)

8. Configure **Connectivity**: Select VPC, Subnet Group, and the created Security Group.
![RDS Create 5](/static/images/2-Proposal/rds_create_5.png)


![RDS Create 6](/static/images/2-Proposal/rds_create_6.png)

9. Configure authentication (**Password authentication**).
![RDS Create 7](/static/images/2-Proposal/rds_create_7.png)

10. Click **Create database**.
![RDS Create 8](/static/images/2-Proposal/rds_create_8.png)

...
![Modify IAM Role](/images/2-Proposal/iam-1%20(1).png)

3.  Select the IAM Role created in previous steps (e.g., `EC2RoleForSSM`) and click **Update IAM role**.

![Select IAM Role](/images/2-Proposal/iam-2%20(1).png)
...
![Update System](/images/2-Proposal/update-system.png)
...
```
![Install Java](/images/2-Proposal/install-java.png)
...
![Check Install](/images/2-Proposal/check-install.png)
...
![Install MariaDB](/images/2-Proposal/install-maria-db.png)
...
![Create Database RDS](/images/2-Proposal/create-database-rds.png)
...
![Create service](/images/2-Proposal/create-service-file.png)

Enter the service file content, configure environment variables for the application

![Setup env](/images/2-Proposal/env-setup.png)
...
![Check status](/images/2-Proposal/check-status-service.png)

...
![Modify IAM Role](/static/images/2-Proposal/iam-1%20(1).png)

3.  Select the IAM Role created in previous steps (e.g., `EC2RoleForSSM`) and click **Update IAM role**.

![Select IAM Role](/static/images/2-Proposal/iam-2%20(1).png)
...
![Update System](/static/images/2-Proposal/update-system.png)
...
```
![Install Java](/static/images/2-Proposal/install-java.png)
...
![Check Install](/static/images/2-Proposal/check-install.png)
...
![Install MariaDB](/static/images/2-Proposal/install-maria-db.png)
...
![Create Database RDS](/static/images/2-Proposal/create-database-rds.png)
...
![Create service](/static/images/2-Proposal/create-service-file.png)

Enter the service file content, configure environment variables for the application

![Setup env](/static/images/2-Proposal/env-setup.png)
...
![Check status](/static/images/2-Proposal/check-status-service.png)

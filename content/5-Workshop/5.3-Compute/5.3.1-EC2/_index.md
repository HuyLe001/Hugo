...
![EC2 Setup 2](/static/images/2-Proposal/ec2_setup_2.png)

7. Configure storage (default 8GB or increase if needed).
8. Advanced details:
    - **IAM instance profile**: Select `Auction-EC2-Role`.
![EC2 Setup 3](/static/images/2-Proposal/ec2_setup_3.png)
...
![EIP 1](/static/images/2-Proposal/elastic_ip.png)
2. Select the created IP -> **Associate Elastic IP address**.
![EIP 2](/static/images/2-Proposal/elastic_ip_2.png)
3. Select the created Instance.
![EIP 3](/static/images/2-Proposal/elastic_ip_3.png)
